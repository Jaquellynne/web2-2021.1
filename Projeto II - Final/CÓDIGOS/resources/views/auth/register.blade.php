                        ...
                        <div class="card-body ">
                            <form class="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="input-group{{ $errors->has('cpf') ? ' has-danger' : '' }}">
                                    ...
                                    <input name="cpf" type="cpf" class="form-control" placeholder="CPF" required value="{{ old('cpf') }}">
                                    @if ($errors->has('cpf'))
                                        <span class="invalid-feedback" style="display: block;" role="alert">
                                ...
                                <div class="input-group{{ $errors->has('nivelAcesso') ? ' has-danger' : '' }}">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            <i class="fa fa-id-badge"></i>
                                        </span>
                                    </div>
                                    <input name="nivelAcesso" type="nivelAcesso" class="form-control" placeholder="Nivel de Acesso" required value="{{ old('nivelAcesso') }}">
                                    @if ($errors->has('nivelAcesso'))
                                        <span class="invalid-feedback" style="display: block;" role="alert">
                                            <strong>{{ $errors->first('nivelAcesso') }}</strong>
                                        </span>
                                    @endif
                                </div>
