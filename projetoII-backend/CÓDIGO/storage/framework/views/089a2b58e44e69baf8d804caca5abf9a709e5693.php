...
<?php $__env->startSection('content'); ?>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h6 class="d-flex justify-content-end">
                            <a class="btn btn-info" href="<?php echo e(route('funcionario.create')); ?>">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $funcionarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $funcionario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-center">
                                            ...
                                            <td><?php echo e($funcionario->endereco); ?></td>
                                            <td><?php echo e($funcionario->telefone); ?></td>
                                            <td><?php echo e($funcionario->email); ?></td>
                                            <td><?php echo e(date('d/m/Y', strtotime($funcionario->dataNascimento))); ?></td>
                                            <td style="width:220px;">
                                                <a class="btn btn-warning"
                                                    href="<?php echo e(route('funcionario.edit', $funcionario->id)); ?>">
                                                    <i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i>
                                                </a>
                                                <!-- Button trigger modalExcluir -->
                                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                                    data-target="#excluir-<?php echo e($funcionario->id); ?>">
    ...
    <?php echo $__env->make('pages.funcionario.modal.excluir', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\projetos\systemcar\resources\views/pages/funcionario/index.blade.php ENDPATH**/ ?>