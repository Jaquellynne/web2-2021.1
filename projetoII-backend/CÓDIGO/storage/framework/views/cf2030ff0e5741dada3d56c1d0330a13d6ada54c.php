<script>
    $(document).ready(function() {
        ...
        $('#addprod').click(function() {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo e(route('compra.buscaprod')); ?>",
                data: {
    ...
    function trazValor(id) {
        ...
        if (produto >= 2) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo e(route('compra.buscapreco')); ?>",
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
                    produto_id
                },
...
<?php /**PATH C:\laragon\www\projetos\systemcar\resources\views/pages/compra/scripts/formataProdutos.blade.php ENDPATH**/ ?>