...
<?php $__env->startSection('content'); ?>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h6 class="d-flex justify-content-end">
                            <a class="btn btn-info" href="<?php echo e(route('fornecedor.create')); ?>">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="width:220px;">
                                                <a class="btn btn-warning"
                                                    href="<?php echo e(route('fornecedor.edit', $fornecedor->id)); ?>">
                                                    <i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i>
                                                </a>
                                                <!-- Button trigger modalExcluir -->
                                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                                    data-target="#excluir-<?php echo e($fornecedor->id); ?>">
    ...
    <?php echo $__env->make('pages.fornecedor.modal.excluir', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\projetos\systemcar\resources\views/pages/fornecedor/index.blade.php ENDPATH**/ ?>